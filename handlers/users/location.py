...
async def location_handler(message: types.Message, state: FSMContext):
    ...
    await message.answer_photo(photo="AgACAgIAAxkBAAIHQ2FQeaWAJNuVOT69C7ZidkrcRZVYAALFtTEbp1aJSqPtScWJ3G5fAQADAgADcwADIQQ", caption=text, reply_markup=create_restaurant_kb(r_id))
